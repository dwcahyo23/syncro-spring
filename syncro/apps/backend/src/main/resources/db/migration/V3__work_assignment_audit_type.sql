-- ============================================================================
-- V3: Work-assignment audit label (story 17-1, blueprint B3)
-- Additive-only migration on top of the V1 baseline. Extends the
-- ck_audit_log_entity_type CHECK with the WORK_ASSIGNMENT value that
-- AuditEntityType.WORK_ASSIGNMENT writes (the doc comment on that enum
