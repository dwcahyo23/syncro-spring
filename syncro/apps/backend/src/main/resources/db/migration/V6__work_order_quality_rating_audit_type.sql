-- ============================================================================
-- V6: Workorder quality rating audit label (story 17-5, blueprint C4)
-- Additive-only migration extending the ck_audit_log_entity_type CHECK with
-- WORK_ORDER_QUALITY_RATING that AuditEntityType.WORK_ORDER_QUALITY_RATING
-- writes (the doc comment on that enum requires the Java enum and the SQL CHECK
-- to move together in one change).
-- ============================================================================
