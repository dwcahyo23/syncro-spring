...
--   of dummy work orders covering the full lifecycle (OPEN -> ASSIGNED ->
--   IN_PROGRESS -> DONE / CLOSED / CANCELLED) with status history, repair
--   sessions and todos.
--
-- Canonical values:
...
--   Categories      01 Breakdown, 03 Repair (02 Preventive comes from V56)
...
--   Work orders     WO-2608-01001..01025 (25 rows) covering OPEN / ASSIGNED /
--                   IN_PROGRESS / ON_PROCUREMENT / DONE / CLOSED / CANCELLED -
...
--                   seeded ids. A pre-existing WO-2608-00001 (created via the
--                   backend) is adopted untouched, never deleted.
--
-- Preconditions:
--   Flyway migrations V1..V67 applied (backend booted once against the local
...
SELECT 'WO-2608-01001', 'INTERNAL', NULL, 'OPEN', c.id, m.id, 'Mesin mati total, indikator error E-07 saat running. Perlu pengecekan PLC dan kelistrikan.', 0, NULL, NULL, mgr.id, '2026-08-29T08:00:00Z', '2026-08-29T08:00:00Z'
...
WHERE c.code = '01' AND p.code = '01' AND m.plant_id = p.id AND m.code = 'BF-08410' AND mgr.login_identifier = 'manager@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM work_orders WHERE id = 'WO-2608-01001');

INSERT INTO work_orders (id, source, parent_id, status, category_id, machine_id, description, sync_version, idempotency_key, assigned_technician_id, created_by, created_at, updated_at)
SELECT 'WO-2608-01002', 'INTERNAL', NULL, 'ASSIGNED', c.id, m.id, 'Suara abnormal pada gearbox, getaran tinggi. Ditugaskan ke teknisi untuk investigasi.', 0, NULL, tech.id, leader.id, '2026-08-29T09:30:00Z', '2026-08-29T10:15:00Z'
...
WHERE c.code = '01' AND p.code = '01' AND m.plant_id = p.id AND m.code = 'BF-08410' AND tech.login_identifier = 'technician.01@syncro.dev' AND leader.login_identifier = 'leader.01@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM work_orders WHERE id = 'WO-2608-01002');

INSERT INTO work_orders (id, source, parent_id, status, category_id, machine_id, description, sync_version, idempotency_key, assigned_technician_id, created_by, created_at, updated_at)
SELECT 'WO-2608-01003', 'INTERNAL', NULL, 'IN_PROGRESS', c.id, m.id, 'Perbaikan pendinginan oli hidrolik. Penggantian filter dan flush sistem.', 0, NULL, tech.id, leader.id, '2026-08-29T11:00:00Z', '2026-08-29T11:20:00Z'
FROM work_order_categories c, machines m, plants p, auth_users tech, auth_users leader
WHERE c.code = '03' AND p.code = '01' AND m.plant_id = p.id AND m.code = 'BF-08409' AND tech.login_identifier = 'technician.01@syncro.dev' AND leader.login_identifier = 'leader.01@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM work_orders WHERE id = 'WO-2608-01003');
...
SELECT 'WO-2608-01004', 'INTERNAL', NULL, 'DONE', c.id, m.id, 'Ganti solenoid valve pneumatik yang bocor. Test cycle normal kembali.', 0, NULL, tech.id, leader.id, '2026-08-28T07:00:00Z', '2026-08-28T09:00:00Z', 45, 'Selesai sesuai prosedur'
FROM work_order_categories c, machines m, plants p, auth_users tech, auth_users leader
WHERE c.code = '01' AND p.code = '01' AND m.plant_id = p.id AND m.code = 'BF-08410' AND tech.login_identifier = 'technician.01@syncro.dev' AND leader.login_identifier = 'leader.01@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM work_orders WHERE id = 'WO-2608-01004');

INSERT INTO work_orders (id, source, parent_id, status, category_id, machine_id, description, sync_version, idempotency_key, assigned_technician_id, created_by, created_at, updated_at, mttr_minutes, done_reason)
SELECT 'WO-2608-01005', 'INTERNAL', NULL, 'CLOSED', c.id, m.id, 'Perbaikan minor: pengencangan baut dan pelumasan slide. Ditutup setelah verifikasi.', 0, NULL, tech.id, leader.id, '2026-08-27T13:00:00Z', '2026-08-27T15:00:00Z', 30, 'Verifikasi leader selesai'
FROM work_order_categories c, machines m, plants p, auth_users tech, auth_users leader
WHERE c.code = '01' AND p.code = '01' AND m.plant_id = p.id AND m.code = 'BF-08409' AND tech.login_identifier = 'technician.01@syncro.dev' AND leader.login_identifier = 'leader.01@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM work_orders WHERE id = 'WO-2608-01005');

INSERT INTO work_orders (id, source, parent_id, status, category_id, machine_id, description, sync_version, idempotency_key, assigned_technician_id, created_by, created_at, updated_at)
SELECT 'WO-2608-01006', 'INTERNAL', NULL, 'CANCELLED', c.id, m.id, 'Duplikat laporan. Dibatalkan, masalah sudah ditangani WO lain.', 0, NULL, NULL, mgr.id, '2026-08-26T14:00:00Z', '2026-08-26T14:30:00Z'
FROM work_order_categories c, machines m, plants p, auth_users mgr
WHERE c.code = '01' AND p.code = '01' AND m.plant_id = p.id AND m.code = 'BF-08410' AND mgr.login_identifier = 'manager@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM work_orders WHERE id = 'WO-2608-01006');

INSERT INTO work_orders (id, source, parent_id, status, category_id, machine_id, description, sync_version, idempotency_key, assigned_technician_id, created_by, created_at, updated_at)
SELECT 'WO-2608-01007', 'INTERNAL', NULL, 'OPEN', c.id, m.id, 'Mesin tidak bisa start, indikator safety relay aktif. Perlu cek rangkaian safety.', 0, NULL, NULL, mgr.id, '2026-08-30T08:00:00Z', '2026-08-30T08:00:00Z'
FROM work_order_categories c, machines m, plants p, auth_users mgr
WHERE c.code = '01' AND p.code = '02' AND m.plant_id = p.id AND m.code = 'BF-08411' AND mgr.login_identifier = 'manager@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM work_orders WHERE id = 'WO-2608-01007');

INSERT INTO work_orders (id, source, parent_id, status, category_id, machine_id, description, sync_version, idempotency_key, assigned_technician_id, created_by, created_at, updated_at)
SELECT 'WO-2608-01008', 'INTERNAL', NULL, 'ASSIGNED', c.id, m.id, 'Pelumasan otomatis tidak berfungsi pada stasiun 3. Ditugaskan ke teknisi.', 0, NULL, tech.id, leader.id, '2026-08-30T09:00:00Z', '2026-08-30T09:45:00Z'
FROM work_order_categories c, machines m, plants p, auth_users tech, auth_users leader
WHERE c.code = '03' AND p.code = '02' AND m.plant_id = p.id AND m.code = 'BF-08411' AND tech.login_identifier = 'technician.02@syncro.dev' AND leader.login_identifier = 'leader.02@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM work_orders WHERE id = 'WO-2608-01008');
...
FROM (VALUES
  ('WO-2608-01009', 'OPEN',           '01', 'BF-08409', '01', NULL,                       'Roller atas aus, quality reject meningkat.',             'manager@syncro.dev',   '2026-08-28T08:00:00Z', '2026-08-28T08:00:00Z', NULL, NULL),
  ('WO-2608-01010', 'ASSIGNED',       '01', 'BF-08410', '01', 'technician.01@syncro.dev', 'Kebocoran udara pada manifold pneumatik.',              'leader.01@syncro.dev', '2026-08-28T09:00:00Z', '2026-08-28T09:30:00Z', NULL, NULL),
  ('WO-2608-01011', 'IN_PROGRESS',    '03', 'BF-08409', '01', 'technician.01@syncro.dev', 'Kalibrasi sensor suhu zona curing.',                    'leader.01@syncro.dev', '2026-08-28T10:00:00Z', '2026-08-28T10:20:00Z', NULL, NULL),
  ('WO-2608-01012', 'ON_PROCUREMENT', '01', 'BF-08410', '01', 'technician.01@syncro.dev', 'Menunggu sparepart motor servo penggerak konveyor.',    'leader.01@syncro.dev', '2026-08-27T11:00:00Z', '2026-08-27T12:00:00Z', NULL, NULL),
  ('WO-2608-01013', 'DONE',           '03', 'BF-08409', '01', 'technician.01@syncro.dev', 'Penggantian bearing motor utama.',                       'leader.01@syncro.dev', '2026-08-27T07:00:00Z', '2026-08-27T09:10:00Z', 70, 'Selesai, mesin jalan normal'),
  ('WO-2608-01014', 'DONE',           '01', 'BF-08410', '01', 'technician.01@syncro.dev', 'Perbaikan kebocoran oli seal silinder hidrolik.',       'leader.01@syncro.dev', '2026-08-26T08:30:00Z', '2026-08-26T10:45:00Z', 85, 'Seal diganti, tidak ada kebocoran'),
  ('WO-2608-01015', 'CLOSED',         '03', 'BF-08409', '01', 'technician.01@syncro.dev', 'Preventive: pengencangan dan pelumasan berkala.',        'leader.01@syncro.dev', '2026-08-26T13:00:00Z', '2026-08-26T15:00:00Z', 35, 'Verifikasi selesai'),
  ('WO-2608-01016', 'CLOSED',         '01', 'BF-08410', '01', 'technician.01@syncro.dev', 'Ganti proximity sensor posisi stasiun 2.',               'leader.01@syncro.dev', '2026-08-25T09:00:00Z', '2026-08-25T10:30:00Z', 40, 'Selesai, kalibrasi ulang OK'),
  ('WO-2608-01017', 'CANCELLED',      '01', 'BF-08409', '01', NULL,                       'Tiket duplikat, ditutup manual.',                        'manager@syncro.dev',   '2026-08-25T14:00:00Z', '2026-08-25T14:15:00Z', NULL, NULL),
  ('WO-2608-01018', 'OPEN',           '01', 'BF-08411', '02', NULL,                       'Error alarm suhu overload pada heater.',                  'manager@syncro.dev',   '2026-08-29T07:30:00Z', '2026-08-29T07:30:00Z', NULL, NULL),
  ('WO-2608-01019', 'ASSIGNED',       '03', 'BF-08411', '02', 'technician.02@syncro.dev', 'Pengecekan kelistrikan panel kontrol.',                   'leader.02@syncro.dev', '2026-08-29T08:30:00Z', '2026-08-29T09:00:00Z', NULL, NULL),
  ('WO-2608-01020', 'IN_PROGRESS',    '01', 'BF-08411', '02', 'technician.02@syncro.dev', 'Perbaikan sistem clamp yang tidak presisi.',              'leader.02@syncro.dev', '2026-08-29T10:00:00Z', '2026-08-29T10:30:00Z', NULL, NULL),
  ('WO-2608-01021', 'ON_PROCUREMENT', '01', 'BF-08411', '02', 'technician.02@syncro.dev', 'Menunggu valve pneumatik pengganti.',                     'leader.02@syncro.dev', '2026-08-28T11:00:00Z', '2026-08-28T12:00:00Z', NULL, NULL),
  ('WO-2608-01022', 'DONE',           '03', 'BF-08411', '02', 'technician.02@syncro.dev', 'Ganti filter udara kompresor.',                           'leader.02@syncro.dev', '2026-08-28T07:00:00Z', '2026-08-28T08:40:00Z', 55, 'Selesai, tekanan normal'),
  ('WO-2608-01023', 'CLOSED',         '01', 'BF-08411', '02', 'technician.02@syncro.dev', 'Perbaikan wiring putus pada kabel sensor.',               'leader.02@syncro.dev', '2026-08-27T13:30:00Z', '2026-08-27T15:10:00Z', 50, 'Verifikasi leader selesai'),
  ('WO-2608-01024', 'CLOSED',         '03', 'BF-08411', '02', 'technician.02@syncro.dev', 'Rutin: pelumasan rel slide dan rack.',                    'leader.02@syncro.dev', '2026-08-27T09:00:00Z', '2026-08-27T10:20:00Z', 30, 'Selesai sesuai jadwal'),
  ('WO-2608-01025', 'CANCELLED',      '01', 'BF-08411', '02', NULL,                       'Dibatalkan, tidak ditemukan kerusakan.',                  'manager@syncro.dev',   '2026-08-26T15:00:00Z', '2026-08-26T15:30:00Z', NULL, NULL)
...
WITH path(step, from_status, to_status, applies_to) AS (
  VALUES
    (1, 'OPEN',         'ASSIGNED',       'ASSIGNED'),
    (1, 'OPEN',         'ASSIGNED',       'IN_PROGRESS'),
    (2, 'ASSIGNED',     'IN_PROGRESS',    'IN_PROGRESS'),
    (1, 'OPEN',         'ASSIGNED',       'ON_PROCUREMENT'),
    (2, 'ASSIGNED',     'IN_PROGRESS',    'ON_PROCUREMENT'),
    (3, 'IN_PROGRESS',  'ON_PROCUREMENT', 'ON_PROCUREMENT'),
    (1, 'OPEN',         'ASSIGNED',       'DONE'),
    (2, 'ASSIGNED',     'IN_PROGRESS',    'DONE'),
    (3, 'IN_PROGRESS',  'DONE',           'DONE'),
    (1, 'OPEN',         'ASSIGNED',       'CLOSED'),
    (2, 'ASSIGNED',     'IN_PROGRESS',    'CLOSED'),
    (3, 'IN_PROGRESS',  'DONE',           'CLOSED'),
    (4, 'DONE',         'CLOSED',         'CLOSED'),
...
SELECT gen_random_uuid(), 'WO-2608-01003', tech.id, 'Flush sistem hidrolik dan penggantian filter pendingin', '2026-08-29T11:30:00Z', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM auth_users tech
WHERE tech.login_identifier = 'technician.01@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM repair_sessions WHERE work_order_id = 'WO-2608-01003');

INSERT INTO repair_sessions (id, work_order_id, technician_id, description, started_at, ended_at, duration_minutes, created_at, updated_at)
SELECT gen_random_uuid(), 'WO-2608-01004', tech.id, 'Ganti solenoid valve dan test cycle', '2026-08-28T07:15:00Z', '2026-08-28T08:00:00Z', 45, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
FROM auth_users tech
WHERE tech.login_identifier = 'technician.01@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM repair_sessions WHERE work_order_id = 'WO-2608-01004');

-- ---------------------------------------------------------------------------
-- 12. Todos on the IN_PROGRESS work order
-- ---------------------------------------------------------------------------
INSERT INTO workorder_todos (id, workorder_id, title, description, assigned_technician_id, status, sort_order, created_by, created_at, updated_at)
SELECT gen_random_uuid(), 'WO-2608-01003', 'Ganti filter oli', 'Filter oli hidrolik part #FLT-HY-01', tech.id, 'COMPLETED', 1, tech.id, '2026-08-29T11:30:00Z', '2026-08-29T12:00:00Z'
FROM auth_users tech
WHERE tech.login_identifier = 'technician.01@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM workorder_todos WHERE workorder_id = 'WO-2608-01003' AND title = 'Ganti filter oli');

INSERT INTO workorder_todos (id, workorder_id, title, description, assigned_technician_id, status, sort_order, created_by, created_at, updated_at)
SELECT gen_random_uuid(), 'WO-2608-01003', 'Verifikasi suhu oli normal', 'Pastikan suhu 40-60C setelah running 30 menit', tech.id, 'PENDING', 2, tech.id, '2026-08-29T11:30:00Z', '2026-08-29T11:30:00Z'
FROM auth_users tech
WHERE tech.login_identifier = 'technician.01@syncro.dev'
  AND NOT EXISTS (SELECT 1 FROM workorder_todos WHERE workorder_id = 'WO-2608-01003' AND title = 'Verifikasi suhu oli normal');
...
--     next generated id is at least WO-2608-01026.
-- ---------------------------------------------------------------------------
