  ...
  return (
    <main className="mx-auto flex w-full max-w-md flex-col justify-center space-y-6 p-8 text-center">
      <div className="space-y-2">
        ...
        <h1 className="font-medium text-3xl">Login shell placeholder</h1>
        <p className="text-muted-foreground text-sm">Authentication mode and login behavior arrive in Story 1.5.</p>
      </div>
