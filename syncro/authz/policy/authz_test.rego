...
test_section_leader_workorder_assignment_create_allowed if {
  authz.allow with input as {"subject": {"roles": ["SECTION_LEADER"], "userId": "u5"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}

test_manager_workorder_assignment_create_allowed if {
  authz.allow with input as {"subject": {"roles": ["MANAGER_MAINTENANCE"], "userId": "u2"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}

test_maintenance_leader_workorder_assignment_create_allowed if {
  authz.allow with input as {"subject": {"roles": ["MAINTENANCE_LEADER"], "userId": "u7"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}

test_super_admin_workorder_assignment_create_allowed if {
  authz.allow with input as {"subject": {"roles": ["SUPER_ADMIN"], "userId": "u1"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}

test_section_leader_workorder_assignment_drop_allowed if {
  authz.allow with input as {"subject": {"roles": ["SECTION_LEADER"], "userId": "u5"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments/7b7c6d5e-1111-2222-3333-444455556666/drop"}
}

test_manager_workorder_assignment_drop_allowed if {
  authz.allow with input as {"subject": {"roles": ["MANAGER_MAINTENANCE"], "userId": "u2"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments/7b7c6d5e-1111-2222-3333-444455556666/drop"}
}

test_technician_workorder_assignment_create_denied if {
  not authz.allow with input as {"subject": {"roles": ["TECHNICIAN"], "userId": "u4"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}

test_technician_workorder_assignment_drop_denied if {
  not authz.allow with input as {"subject": {"roles": ["TECHNICIAN"], "userId": "u4"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments/7b7c6d5e-1111-2222-3333-444455556666/drop"}
}

test_staff_workorder_assignment_create_denied if {
  not authz.allow with input as {"subject": {"roles": ["STAFF_MAINTENANCE"], "userId": "u3"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}

test_production_leader_workorder_assignment_create_denied if {
  not authz.allow with input as {"subject": {"roles": ["PRODUCTION_LEADER"], "userId": "u8"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}

test_auditor_workorder_assignment_create_denied if {
  not authz.allow with input as {"subject": {"roles": ["AUDITOR"], "userId": "u6"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}

test_anonymous_workorder_assignment_denied if {
  not authz.allow with input as {"subject": {"roles": [], "userId": null}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}

test_auditor_workorder_assignment_read_allowed if {
  authz.allow with input as {"subject": {"roles": ["AUDITOR"], "userId": "u6"}, "action": "GET /api/v1/workorders/WO-2409-00001/assignments"}
}

test_maintenance_leader_workorder_assignment_drop_allowed if {
  authz.allow with input as {"subject": {"roles": ["MAINTENANCE_LEADER"], "userId": "u7"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments/7b7c6d5e-1111-2222-3333-444455556666/drop"}
}

test_super_admin_workorder_assignment_drop_allowed if {
  authz.allow with input as {"subject": {"roles": ["SUPER_ADMIN"], "userId": "u1"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments/7b7c6d5e-1111-2222-3333-444455556666/drop"}
}

test_staff_workorder_assignment_drop_denied if {
  not authz.allow with input as {"subject": {"roles": ["STAFF_MAINTENANCE"], "userId": "u3"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments/7b7c6d5e-1111-2222-3333-444455556666/drop"}
}

test_storekeeper_workorder_assignment_create_denied if {
  not authz.allow with input as {"subject": {"roles": ["STOREKEEPER"], "userId": "u10"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}

test_inventory_workorder_assignment_create_denied if {
  not authz.allow with input as {"subject": {"roles": ["INVENTORY_MAINTENANCE"], "userId": "u9"}, "action": "POST /api/v1/workorders/WO-2409-00001/assignments"}
}
